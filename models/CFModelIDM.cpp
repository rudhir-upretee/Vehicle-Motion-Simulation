...
CFModelIDM::CFModelIDM(double desVel, double initHeadwayTime, double strStblHeadwayTime,
...
double CFModelIDM::getAcclrResponse(double time, Vehicle& veh, Vehicle pred, double& hdwayTimeUsed) {
...
double CFModelIDM::getAcclrResponseInNetwork(double time, Vehicle& veh, Vehicle pred, double& hdwayTimeUsed) {
	double velVeh = veh.getVel();
	double interVehDist = pred.getPosX() - veh.getPosX();
	double velDiff =  veh.getVel() - pred.getVel();
...
double CFModelIDM::getStringStableHeadwayTime() {
